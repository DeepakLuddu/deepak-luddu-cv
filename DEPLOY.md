...
If you don't have a Vercel account yet, this same flow creates one for you — there's nothing extra to sign up for.
...
| Project name? | `deepak-luddu` (or anything you like — this becomes part of the URL) |
...
1. Buy a domain — Namecheap, Porkbun, or Cloudflare are all good. ~$10–15/year.
